package com.learning.epstask.common.extensions
...
fun Fragment.toastyInfo(text: String?) {
    text?.let {
        Toasty.info(requireContext(), text, Toast.LENGTH_SHORT, true)
            .show();
    }
}
...
//FancyToast->custom toast library
fun Fragment.fancyToastSuccess(text: String?) {
    text.let {
        FancyToast.makeText(
            requireContext(), text, FancyToast.LENGTH_SHORT,
            FancyToast.SUCCESS, false
        ).show()
    }
}

fun Fragment.fancyToastError(text: String?) {
    text.let {
        FancyToast.makeText(
            requireContext(), text, FancyToast.LENGTH_SHORT,
            FancyToast.ERROR, false
...
fun Fragment.fancyToastWarning(text: String?) {
    text.let {
        FancyToast.makeText(
            requireContext(), text, FancyToast.LENGTH_SHORT,
            FancyToast.WARNING, false
...
fun Fragment.fancyToastInfo(text: String?) {
    text.let {
        FancyToast.makeText(
            requireContext(), text, FancyToast.LENGTH_SHORT,
            FancyToast.INFO, false
